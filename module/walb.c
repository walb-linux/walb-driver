...
static struct walb_bios_work* walb_create_bios_work(
        struct walb_dev *wdev,
...
static struct walb_bioclist_work* walb_create_bioclist_work(
        struct walb_dev *wdev, struct request *req, gfp_t gfp_mask);
